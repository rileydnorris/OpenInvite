...
typedef SWIFT_ENUM_NAMED(NSInteger, DepthPreset, "DepthPreset", closed) {
  DepthPresetNone = 0,
  DepthPresetDepth1 = 1,
  DepthPresetDepth2 = 2,
  DepthPresetDepth3 = 3,
...
typedef SWIFT_ENUM_NAMED(NSInteger, DeviceModel, "DeviceModel", closed) {
  ...
  DeviceModelIPhone4s = 2,
  DeviceModelIPhone5 = 3,
  DeviceModelIPhone5c = 4,
  DeviceModelIPhone5s = 5,
  DeviceModelIPhone6 = 6,
  DeviceModelIPhone6Plus = 7,
  DeviceModelIPhone6s = 8,
  DeviceModelIPhone6sPlus = 9,
  DeviceModelIPhone7 = 10,
  DeviceModelIPhone7Plus = 11,
  DeviceModelIPhone8 = 12,
  DeviceModelIPhone8Plus = 13,
  DeviceModelIPhoneX = 14,
  DeviceModelIPhoneSE = 15,
  DeviceModelIPad2 = 16,
  DeviceModelIPad3 = 17,
  DeviceModelIPad4 = 18,
  DeviceModelIPadAir = 19,
  DeviceModelIPadAir2 = 20,
  DeviceModelIPadMini = 21,
  DeviceModelIPadMini2 = 22,
  DeviceModelIPadMini3 = 23,
  DeviceModelIPadMini4 = 24,
  DeviceModelIPadPro = 25,
  DeviceModelIPadProLarge = 26,
  DeviceModelIPad5 = 27,
  DeviceModelIPadPro2 = 28,
  DeviceModelIPadProLarge2 = 29,
  DeviceModelIPad6 = 30,
  DeviceModelSimulator = 31,
  DeviceModelUnknown = 32,
};
...
typedef SWIFT_ENUM_NAMED(NSInteger, Gravity, "Gravity", closed) {
  GravityCenter = 0,
  GravityTop = 1,
  GravityBottom = 2,
  GravityLeft = 3,
...
typedef SWIFT_ENUM_NAMED(NSInteger, HeightPreset, "HeightPreset", closed) {
  HeightPresetNone = 0,
  HeightPresetTiny = 20,
...
typedef SWIFT_ENUM_NAMED(NSInteger, SwitchSize, "SwitchSize", closed) {
  SwitchSizeSmall = 0,
  SwitchSizeMedium = 1,
  SwitchSizeLarge = 2,
};
...
typedef SWIFT_ENUM_NAMED(NSInteger, SwitchStyle, "SwitchStyle", closed) {
  SwitchStyleLight = 0,
  SwitchStyleDark = 1,
};
